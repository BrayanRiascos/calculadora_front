...
function Calculadora() {
    ...
    useEffect(() => {
        fetch('https://calculadora-back-omega.vercel.app/v1/calculadora/historial')
            .then(res => res.json())
    ...
    function handleSubmit(e) {
        ...
        if (operacion === 'calcularEcuacion') {
            ...
            fetch('https://calculadora-back-omega.vercel.app/v1/calculadora/calcularEcuacion', {
                method: 'POST',
            ...
            fetch(`https://calculadora-back-omega.vercel.app/v1/calculadora/${endpoint}`, {
                method: 'POST',
                headers: { "Content-Type": "application/json" },
